---
id: srv-oficina-virtual
lang: en
url: /en/virtual-office/
layout: servicio
servicio: oficina-virtual
title: "Virtual office and registered address in Spain | OficinasYA!"
...
perfiles:
  - Small companies and freelancers who do not want their registered address to be their home.
  - Entrepreneurs and start-ups that need a serious address before they need an office.
  - Professionals who work remotely.
  - Companies that want a presence in another city without opening a physical branch.
cifras:
  - { num: "From €{{ p.oficina_virtual_mes }}", label: "a month + VAT, the network's starting price" }
  - { num: "{{ n.smart_office }} of {{ g.espacios }}", label: "spaces in the network offer it" }
  - { num: "{{ g.ciudades }}", label: "cities: it is available in all of them" }
tarjetas:
  ...
  - titulo: Visitor reception
    texto: "When a client comes to see you, reception welcomes them and shows them to the room you have booked."
...
pasos:
  - titulo: Choose the centre
    texto: "It can be the one in your city or the one in the city where you want a presence. Each city page has the exact address and the reception hours, which are the hours during which calls and visitors are attended."
  - titulo: "Call {{ g.telefono }} or write on WhatsApp"
    texto: "We confirm the centre's fee and the services you want to add."
  - titulo: Sign and use the address from that day
    texto: "The contract runs month to month, with the usual company or freelancer documentation. From the moment you sign, reception is already receiving your mail and your calls."
donde_dato:
  num: "{{ n.smart_office }} spaces"
  texto: "The virtual office is available at {{ n.smart_office }} spaces across the network's {{ g.ciudades }} cities; only the two colivings do not offer it."
ofertas:
  - nombre: Virtual office
    precio: oficina_virtual_mes
    unidad: mes
    unit_code: MON
    detalle: Registered and trading address, mail handling and optional call answering.
incluye:
  - Registered and trading address at the centre
  - Receipt of mail, parcels and notifications
  - Immediate notice of anything that arrives
  - Visitor reception at the centre
  - Optional call answering in your company's name
  - Offices and meeting rooms by the hour
  - Hot desks across the network
no_incluye:
  - An office for your exclusive use (that is the monthly office)
  - Company formation or accountancy paperwork
  - Mail forwarding, which is agreed with the centre
...
faq:
  ...
  - q: What happens to mail that arrives in my name?
    a: "The centre's reception receives it and lets you know straight away. You then collect it when you drop by the centre or, if you prefer, it is forwarded to the address you indicate, on the terms set by the centre. The same applies to parcels."
...
A virtual office means having your company at a business centre without occupying an office there. You register your company or your freelance activity at the centre's address, reception receives your mail and your visitors, and your phone is answered by a person in your company's name.

To anyone looking for you, your company is on Calle Velázquez in Madrid, Paseo de la Independencia in Zaragoza or Calle Larios in Málaga. For you, you carry on working from wherever you work.
...
- office hours,
- meeting rooms,
- a workstation in the shared space,
- a phone number answered in your company's name.

The difference from contracting each thing separately is that the services go up and down month by month. One month you need calls answered and mail received; the next, three meetings in a room and two mornings in an office; the one after, nothing but the address. You add and remove services as often as you need without changing contract or centre.

It is the option for people who work from home or on the move, for newly created companies, and for anyone opening a branch in a city without yet knowing how much space they will need.

> At some centres the pack includes meeting-room hours every month or has a reduced annual rate; check the details of the centre you are interested in. And if one day the office by the hour is no longer enough, the move to a [monthly office]({{ urls['srv-despachos'] }}) happens at the same centre.
...
If what you are after is a representative address, the Madrid centres are in the Salamanca district, on the Castellana and in Las Tablas, and outside Madrid on streets such as Larios in Málaga, Independencia in Zaragoza or Plaza de Urquinaona in Barcelona. The full list, with addresses and hours, is on each city page.
